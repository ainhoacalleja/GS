...
# save.image("Lasso_diag_ht10.RData")
# load("Lasso_diag_ht10.RData")
...
# Gelman-Plot
# Create output file 
jpeg(file = "GelmanPlot_BL_ht10.jpg", height = 10, width = 12, res = 1000, units = 'cm')
pdf(paste(outpath,"/GelmanPlot_ht10_BL.pdf",sep=""), width=4, height=3)
